...
# 스타일 적용
ws["A1"].font = Font(color = "FF0000", italic=True, bold=True) # 셀의 글자 색, 이탈릭체, 두껍게 적용
ws["B1"].font = Font(color = "FF0000", name="Arial", strike=True) # 셀의 글자 색, 폰트 변경, 중간줄 적용
ws["C1"].font = Font(color = "FF0000", size=20, underline="single") # 셀의 글자 색, 사이즈 변경, 및줄 적용
